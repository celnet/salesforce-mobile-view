...
var getTemplates = function(){
    ...
    templates = {
        ...
        field_checkbox:document.querySelector('#template-jqm-checkboxradio').text,
        field_currency:document.querySelector('#template-jqm-textinput').text.replace(/{{input-type}}/g,'text'),
        field_date:document.querySelector('#template-jqm-textinput').text.replace(/{{input-type}}/g,'date'),
        field_datetime:document.querySelector('#template-jqm-textinput').text.replace(/{{input-type}}/g,'datetime-local'),
        field_email:document.querySelector('#template-jqm-textinput').text.replace(/{{input-type}}/g,'email'),
        field_geolocation:document.querySelector('#template-field-edit-geolocation').text,
        field_number:document.querySelector('#template-jqm-textinput').text.replace(/{{input-type}}/g,'text'),
        ...
        field_url:document.querySelector('#template-jqm-textinput').text.replace(/{{input-type}}/g,'url'),
